#ifndef MCUCORE_SRC_STRINGS_HAS_PROGMEM_CHAR_ARRAY_H_
#define MCUCORE_SRC_STRINGS_HAS_PROGMEM_CHAR_ARRAY_H_
...
#endif  // MCUCORE_SRC_STRINGS_HAS_PROGMEM_CHAR_ARRAY_H_
