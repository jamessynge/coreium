#ifndef MCUCORE_SRC_STRINGS_PROGMEM_STRING_VIEW_H_
#define MCUCORE_SRC_STRINGS_PROGMEM_STRING_VIEW_H_
...
#endif  // MCUCORE_SRC_STRINGS_PROGMEM_STRING_VIEW_H_
