#ifndef MCUCORE_SRC_LITERAL_H_
#define MCUCORE_SRC_LITERAL_H_
...
#define TAS_DEFINE_LITERAL(name, literal)                 \
  ...
  inline constexpr ::mcucore::Literal name() {            \
    return ::mcucore::Literal(kLiteral_##name);           \
  }

#endif  // !TAS_DEFINE_LITERAL

#endif  // MCUCORE_SRC_LITERAL_H_
