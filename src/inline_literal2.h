#ifndef MCUCORE_SRC_INLINE_LITERAL2_H_
#define MCUCORE_SRC_INLINE_LITERAL2_H_

// Block inclusion of the other impl.
#define MCUCORE_SRC_INLINE_LITERAL_H_

////////////////////////////////////////////////////////////////////////////////
//
// This is an experimental copy of inline_literal.h. My goal is to see if I can
// speed up the compilation of TASLIT, et al, when the supported string size is
// large.
//
// My thought is to use constexprs based on the length N of the string literal,
// as seen here:
//
//     template <int N>
//     constexpr int GetLiteralLength(const char (&buf)[N]) {
//       return N - 1;
//     }
//
// Such a function may be usable in the a compile-time expression used to
// produce a template parameter (e.g. "is the string longer than X").
//
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
// Because we expect almost all string literals to be less than 64 or 128
// characters in length long, we define these two macros without specific
// lengths, and require the developer to use the macros whose name specifies the
// limit when their strings are longer.
...
#endif  // MCUCORE_SRC_INLINE_LITERAL2_H_
