#ifndef EXPERIMENTAL_USERS_JAMESSYNGE_ARDUINO_TAS_SRC_UTILS_LOGGING_H_
#define EXPERIMENTAL_USERS_JAMESSYNGE_ARDUINO_TAS_SRC_UTILS_LOGGING_H_
...
// If request, we apply explicit disablement of the features. This allows a
// single .cc file to disable logging. For example, request_decoder has lots of
...
#endif  // EXPERIMENTAL_USERS_JAMESSYNGE_ARDUINO_TAS_SRC_UTILS_LOGGING_H_
