#ifndef MCUCORE_SRC_HTTP1_REQUEST_ROUTER_H_
#define MCUCORE_SRC_HTTP1_REQUEST_ROUTER_H_

// TODO(jamessynge): Describe why this file exists/what it provides.
/*

Want to be able to express the mapping from a literal full path or a literal
...
If a path (other than "/") ends with a slash, it only applies if the
...
class RequestRouterEntry {
 public:
  RequestRouterEntry();
  virtual ~RequestRouterEntry();
...
#endif  // MCUCORE_SRC_HTTP1_REQUEST_ROUTER_H_
