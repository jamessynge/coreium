...
#include "extras/test_tools/progmem_string_utils.h"  // IWYU pragma: keep it is actually used
#include "extras/test_tools/string_view_utils.h"  // IWYU pragma: keep it is actually used
...
void ExpectPartialTextMatching(MockRequestDecoderListener& rdl,
  ...
  auto handler = [test_info, accumulator, expected_text](
                     EPartialTokenPosition position, StringView text) -> bool {
