#ifndef MCUCORE_EXTRAS_TEST_TOOLS_MOCK_ETHERNET_CLIENT_H_
#define MCUCORE_EXTRAS_TEST_TOOLS_MOCK_ETHERNET_CLIENT_H_
...
#endif  // MCUCORE_EXTRAS_TEST_TOOLS_MOCK_ETHERNET_CLIENT_H_
